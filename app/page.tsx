    ...
    <>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <h1 className={`${styles.heroHeadline} anim-2`}>
            KINETIC PRO<br />
            <span className={styles.heroGold}>FITNESS</span><br />
            ACADEMY
          </h1>
          ...
          {programs.slice(0, 3).map((p) => (
            <Link href={`/programs/${p.slug}`} key={p.slug} className={styles.programCard}>
              <div className={styles.programTop}>
                ...
                <span className={styles.programTag} style={{ borderColor: p.color, color: p.color }}>{p.tag}</span>
              </div>
              <h3 className={styles.programTitle}>{p.title}</h3>
              <p className={styles.programDesc}>{p.description.slice(0, 100)}...</p>
      ...
      <section className={styles.aboutStrip}>
        <div className={styles.aboutLeft}>
          <h2 className={styles.aboutTitle}>NOT JUST FITNESS.<br /><span className={styles.gold}>EDUCATION.</span></h2>
        </div>
      ...
      <section className={styles.testimonialSection}>
        ...
        <Link href="/results" className="btn-outline" style={{ marginTop: "2rem", display: "inline-block" }}>See All Results →</Link>
      </section>
